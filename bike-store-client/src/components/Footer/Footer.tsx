...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-gray-200 text-[#22292f] mt-10 ">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            ...
                            <span className="self-center text-2xl font-semibold">BikeHut</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-1">
                                ...
                                <li>
                                    <a rel="noopener noreferrer" href="#">Bikes</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" href="#">Hot Product</a>
                                </li>
                            </ul>
                        </div>
                        <div className="space-y-3">
                ...
                <div className="py-6 text-sm text-center "> 29 Jan, 2025. Developed By Mosharof Hossen.</div>
            </footer>
        </div>
    );
};
